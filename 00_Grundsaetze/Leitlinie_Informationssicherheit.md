...
## 3. Beispiele für konkrete Vorgaben:
* **Vertraulichkeit:** Alle personenbezogenen Daten müssen im Ruhezustand (at rest) und bei Übertragung (in transit) verschlüsselt sein.
* **Integrität:** Änderungen an Produktionsdatenbanken müssen vier-Augen-prinzip unterliegen.
* **Verfügbarkeit:** Die maximale Ausfallzeit der Kundenschnittstelle beträgt 4 Stunden (RTO).
